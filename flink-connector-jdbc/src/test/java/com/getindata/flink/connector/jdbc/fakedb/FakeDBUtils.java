...
package com.getindata.flink.connector.jdbc.fakedb;
...
public class FakeDBUtils {
    ...
    public static final String DRIVER1_CLASS_NAME =
            "com.getindata.flink.connector.jdbc.fakedb.driver.FakeDriver1";
    public static final String DRIVER2_CLASS_NAME =
            "com.getindata.flink.connector.jdbc.fakedb.driver.FakeDriver2";
    public static final String DRIVER3_CLASS_NAME =
            "com.getindata.flink.connector.jdbc.fakedb.driver.FakeDriver3";
