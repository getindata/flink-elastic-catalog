...
import org.apache.flink.connector.jdbc2.JdbcExecutionOptions;
import org.apache.flink.connector.jdbc2.dialect.JdbcDialect;
import org.apache.flink.connector.jdbc2.dialect.JdbcDialectLoader;
import org.apache.flink.connector.jdbc2.internal.options.JdbcConnectorOptions;
import org.apache.flink.connector.jdbc2.internal.options.JdbcDmlOptions;
import org.apache.flink.connector.jdbc2.internal.options.JdbcLookupOptions;
import org.apache.flink.connector.jdbc2.internal.options.JdbcReadOptions;
...
import static org.apache.flink.connector.jdbc2.table.JdbcConnectorOptions.DRIVER;
import static org.apache.flink.connector.jdbc2.table.JdbcConnectorOptions.LOOKUP_CACHE_MAX_ROWS;
import static org.apache.flink.connector.jdbc2.table.JdbcConnectorOptions.LOOKUP_CACHE_MISSING_KEY;
import static org.apache.flink.connector.jdbc2.table.JdbcConnectorOptions.LOOKUP_CACHE_TTL;
import static org.apache.flink.connector.jdbc2.table.JdbcConnectorOptions.LOOKUP_MAX_RETRIES;
import static org.apache.flink.connector.jdbc2.table.JdbcConnectorOptions.MAX_RETRY_TIMEOUT;
import static org.apache.flink.connector.jdbc2.table.JdbcConnectorOptions.PASSWORD;
import static org.apache.flink.connector.jdbc2.table.JdbcConnectorOptions.SCAN_AUTO_COMMIT;
import static org.apache.flink.connector.jdbc2.table.JdbcConnectorOptions.SCAN_FETCH_SIZE;
...
import static org.apache.flink.connector.jdbc2.table.JdbcConnectorOptions.SINK_BUFFER_FLUSH_INTERVAL;
import static org.apache.flink.connector.jdbc2.table.JdbcConnectorOptions.SINK_BUFFER_FLUSH_MAX_ROWS;
import static org.apache.flink.connector.jdbc2.table.JdbcConnectorOptions.SINK_MAX_RETRIES;
import static org.apache.flink.connector.jdbc2.table.JdbcConnectorOptions.SINK_PARALLELISM;
...
import static org.apache.flink.connector.jdbc2.table.JdbcConnectorOptions.USERNAME;
