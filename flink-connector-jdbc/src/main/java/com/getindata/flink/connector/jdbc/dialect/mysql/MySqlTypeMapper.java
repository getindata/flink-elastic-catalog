...
package com.getindata.flink.connector.jdbc.dialect.mysql;
    ...
    public DataType mapping(ObjectPath tablePath, ResultSetMetaData metadata, int colIndex)
        ...
        switch (mysqlType) {
            ...
            case MYSQL_BINARY:
                ...
                // org.apache.flink.connector.jdbc2.dialect.mysql.MySqlDialect#supportedTypes and
                // org.apache.flink.connector.jdbc2.dialect.AbstractDialect#validate for more
                // details.
