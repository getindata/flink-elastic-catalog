...
import static com.getindata.flink.connector.jdbc.table.JdbcConnectorOptions.DRIVER;
import static com.getindata.flink.connector.jdbc.table.JdbcConnectorOptions.LOOKUP_CACHE_MAX_ROWS;
import static com.getindata.flink.connector.jdbc.table.JdbcConnectorOptions.LOOKUP_CACHE_MISSING_KEY;
import static com.getindata.flink.connector.jdbc.table.JdbcConnectorOptions.LOOKUP_CACHE_TTL;
import static com.getindata.flink.connector.jdbc.table.JdbcConnectorOptions.LOOKUP_MAX_RETRIES;
import static com.getindata.flink.connector.jdbc.table.JdbcConnectorOptions.MAX_RETRY_TIMEOUT;
import static com.getindata.flink.connector.jdbc.table.JdbcConnectorOptions.PASSWORD;
import static com.getindata.flink.connector.jdbc.table.JdbcConnectorOptions.SCAN_AUTO_COMMIT;
import static com.getindata.flink.connector.jdbc.table.JdbcConnectorOptions.SCAN_FETCH_SIZE;
...
import static com.getindata.flink.connector.jdbc.table.JdbcConnectorOptions.SINK_BUFFER_FLUSH_INTERVAL;
import static com.getindata.flink.connector.jdbc.table.JdbcConnectorOptions.SINK_BUFFER_FLUSH_MAX_ROWS;
import static com.getindata.flink.connector.jdbc.table.JdbcConnectorOptions.SINK_MAX_RETRIES;
import static com.getindata.flink.connector.jdbc.table.JdbcConnectorOptions.SINK_PARALLELISM;
...
import static com.getindata.flink.connector.jdbc.table.JdbcConnectorOptions.USERNAME;
